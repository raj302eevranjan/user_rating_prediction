...
<body onload="startTimer()">
  ...
  <tr>
   <th><font  color="#333333;">Select</font></th>
    ...
    <th><font  color="#333333;">MOVCategory</font></th>
      <th><font  color="#333333;">MOVRelease</font></th>
        <th><font  color="#333333;">MOVRate</font></th>
        <th><font  color="#333333;">Image</font></th>
   <th><font  color="#333333;">Add UN</font></th>
  ...
  <td><input type="checkbox" value="<%=rs1.getInt(1) %>" style="width: 100px;" class="input" name="item_id" ></td>
    ...
    <td><input type="text" value="<%=rs1.getString(4)%>" style="width: 100px;" class="input" name="Item_stock" ></td>
      <td><input type="text" value="<%=rs1.getString(7)%>"  style="width: 100px;" class="input" name="Item_prize" ></td>
        <td><img src="<%=request.getContextPath() %>/<%=cnm%>/Item_Images/<%=rs1.getString(5)%>" width="100px""  class="input" name="Item_Image" ></td>
 <input type="hidden" value="<%=rs1.getString(3)%>" name="cat_code" >
    <td><button type="submit" class="shopBtn btn-block"name="submit" value="UN_ADD">Add</button></td>
