    ...
    <body onload="startTimer();">
        ...
        <body>
            ...
            <div style="position:absolute; top:220px; margin-left: 30px; text-align: 20px;">
                <iframe frameborder="0" scrolling="auto" name="afrm" style="height: 500px; width: 1000px;" src="http://localhost:8080/DM_User_ratting_prediction_may18//user_jsp/test.jsp">
                </iframe>
            </div>
